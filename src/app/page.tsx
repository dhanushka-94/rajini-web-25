      ...
      <nav className="fixed w-full bg-black/90 text-white z-50 backdrop-blur-sm">
        <div className="container mx-auto py-4">
          ...
          <div className="flex justify-between items-center">
            <h1 className="text-2xl font-bold gold-text-gradient">Rajini by The Waters</h1>
      ...
      <footer className="bg-black text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <h3 className="text-xl font-bold mb-4 gold-text-gradient">About Us</h3>
